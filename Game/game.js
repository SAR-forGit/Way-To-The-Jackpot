...
////////////////////////////////////////////////////// Question Part ///////////////////////////////////////////////////////////////////////////////
var First_question = question1[(Math.floor(Math.random() * (question1.length)))]
var Second_question = question2[(Math.floor(Math.random() * (question2.length)))]
var Third_question = question3[(Math.floor(Math.random() * (question3.length)))]
var Fourth_question = question4[(Math.floor(Math.random() * (question4.length)))]
var Fifth_question = question5[(Math.floor(Math.random() * (question5.length)))]
var Sixth_question = question6[(Math.floor(Math.random() * (question6.length)))]
var Seven_question = question7[(Math.floor(Math.random() * (question7.length)))]
var Eight_question = question8[(Math.floor(Math.random() * (question8.length)))]
var Nine_question = question9[(Math.floor(Math.random() * (question9.length)))]
var Ten_question = question10[(Math.floor(Math.random() * (question10.length)))]
var Eleventh_question = question11[(Math.floor(Math.random() * (question11.length)))]
var Twelfth_question = question12[(Math.floor(Math.random() * (question12.length)))]
var Thirteen_question = question13[(Math.floor(Math.random() * (question13.length)))]
var Fourteen_question = question14[(Math.floor(Math.random() * (question14.length)))]
var Fifteen_question = question15[(Math.floor(Math.random() * (question15.length)))]
var Sixteen_question = question16[(Math.floor(Math.random() * (question16.length)))]
var Seventeen_question = question17[(Math.floor(Math.random() * (question17.length)))]


var questions = [First_question, Second_question, Third_question, Fourth_question, Fifth_question, Sixth_question, Seven_question, Eight_question, Nine_question, Ten_question, Eleventh_question, Twelfth_question, Thirteen_question, Fourteen_question, Fifteen_question, Sixteen_question, Seventeen_question]
...
const winner = document.getElementById("Winner_Message")

let currentQuestionIndex = 0;
let score = 0;

function Game_Reset_Music(){
    var audio = new Audio("Game_Sources/Game_resetAudio.mp3")
    audio.play()
}

function Game_WrongAnswer_Audio(){
    var audio = new Audio("Game_Sources/Game_WrongAnswerAudio.mp3")
    audio.play()
}

function Game_RightAnswer_Audio(){
    var audio = new Audio("Game_Sources/Game_RightAnswerAudio.mp3")
    audio.play()
}

function Game_WinnerAudio(){
    var audio = new Audio("Game_Sources/Game_WinnerAudio.mp3");
    audio.play();
}
...
function handleNextButton(){
    ...
    if (currentQuestionIndex < questions.length){
        ...
        showScore(); //Change this afterwards
    }
}
